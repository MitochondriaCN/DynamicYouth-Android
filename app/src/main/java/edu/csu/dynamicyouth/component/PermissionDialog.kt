...
@Composable
fun PermissionDialog(permissions: Map<String, String>, isShown: Boolean, onDismissRequest: () -> Unit) {
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    ...
                    Text(
                        modifier = Modifier.fillMaxWidth(),
                        text = stringResource(R.string.TencentMapSDK_Permission),
                        fontSize = 18.sp,
                        textAlign = TextAlign.Center,
                        fontWeight = FontWeight.Bold,
                    )
                    ...
                    Text(
                        modifier = Modifier.fillMaxWidth(),
                        text = stringResource(R.string.TencentLocationSDK_Permission),
                        fontSize = 18.sp,
                        textAlign = TextAlign.Center,
                        fontWeight = FontWeight.Bold,
                    )
